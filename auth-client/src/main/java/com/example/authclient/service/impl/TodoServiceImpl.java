package com.example.authclient.service.impl;
...
public class TodoServiceImpl implements TodoService {
    ...
    public TodoServiceImpl(RestTemplate restTemplate, @Value("${resource-server.uri}") String resourceServerUri) {
    ...
    public List<Todo> findAll() {
        ResponseEntity<List<Todo>> responseEntity = restTemplate.exchange(
            resourceServerUri + "/todos", HttpMethod.GET, null, new ParameterizedTypeReference<List<Todo>>() {});
